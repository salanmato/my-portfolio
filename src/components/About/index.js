    ...
    <div>
      ...
      <div className="about-container">
        ...
        <p className="aboutme-text">
          O mais importante aqui é que o nome do meu cachorro é Chuck Norris e ele tem quase 20 anos de idade.<br/>
          Alguns dos meus hobbies envolvem assistir jogos do Palmeiras, passar 5 minutos para escolher entre um filme coreano de 3 horas e um do Guy Ritchie, e jogar vídeo-game.
          ...
          Estou sempre em busca de aprender algo novo, algumas das atividades que mais gosto envolvem aprendizado, como: desenhar, pintar, saber regras de esportes que não tenho ninguém para discutir sobre, e entender porque existem tantos jogadores coreanos de Tekken de alto nível. 
