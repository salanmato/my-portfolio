    ...
    <div>
      ...
      <div className="about-container">
        ...
        <p className="aboutme-text">
          ...
          Então estou sempre em busca de aprender algo novo, então algumas atividades que gosto também envolvem aprendizado, desenhar, pintar, regras de esportes que não ter ninguém para comentar sobre, e porque existem tantos jogadores coreanos de Tekken de alto nível. 
